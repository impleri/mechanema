(function (global, factory) {
	...
	(factory((global['@mechanema/screw'] = {})));
	...
	var getStateName = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(getStateName);

	var _immutable = ( immutable_es && Immutable ) || immutable_es;

	var getUnexpectedInvocationParameterMessage = createCommonjsModule(function (module, exports) {
	...
	var _getStateName2 = _interopRequireDefault(getStateName);
	...
	unwrapExports(getUnexpectedInvocationParameterMessage);

	var validateNextState = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(validateNextState);
	...
	var _getStateName3 = _interopRequireDefault(getStateName);



	var _getUnexpectedInvocationParameterMessage3 = _interopRequireDefault(getUnexpectedInvocationParameterMessage);



	var _validateNextState3 = _interopRequireDefault(validateNextState);
	...
	var utilities_1 = utilities.validateNextState;
	var utilities_2 = utilities.getUnexpectedInvocationParameterMessage;
	var utilities_3 = utilities.getStateName;

	var combineReducers = createCommonjsModule(function (module, exports) {
	...
	exports.default = function (reducers) {
	  ...
	  return function () {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	      var warningMessage = (0, utilities.getUnexpectedInvocationParameterMessage)(inputState, reducers, action);
	    ...
	    return inputState.withMutations(function (temporaryState) {
	      reducerKeys.forEach(function (reducerName) {
	        ...
	        (0, utilities.validateNextState)(nextDomainState, reducerName, action);
	...
	var _combineReducers3 = _interopRequireDefault(combineReducers);
	...
	unwrapExports(dist);
	var dist_1 = dist.combineReducers;
	...
	function memoize(fn, options) {
	  ...
	  function memoized() {
	    var args = shouldCloneArguments ? cloneArray(arguments) : arguments;
	    ...
	    if (~keyIndex) {
	      ...
	      var newKey = shouldCloneArguments ? key : cloneArray(args);
	...
	var getIsEqual = function getIsEqual(_ref) {
	  ...
	  return equals || isDeepEqual && deepEqual$1 || isReact && shallowEqual || sameValueZeroEqual;
	};
	/**
	 * @private
	 *
	...
	function moize(fn, options) {
	  ...
	  var equalsIgnored = coalescedOptions.equals,
	      ...
	      customOptions = _objectWithoutPropertiesLoose$1(coalescedOptions, ["equals", "isDeepEqual", "isPromise", "isReact", "isSerialized", "matchesKey", "maxAge", "maxArgs", "maxSize", "onCacheAdd", "onCacheChange", "onCacheHit", "onExpire", "profileName", "shouldSerializeFunctions", "serializer", "transformArgs", "updateExpire"]);
	...
	function getSlice(namespace) {
	  return state => state.get(namespace, immutable_1());
	}
